            ...
            <div class="article-body">
                <figure>
                    <img
                        ...
                        title="A Screenshot of the Linux Mint MATE Desktop"
                        cite="https://commons.wikimedia.org"
                        loading="lazy"
                    />
                    <figcaption>A Screenshot of The Linux Mint MATE Desktop</figcaption>
                </figure>
                <blockquote class="article-quotes" cite="book: How Linux Works, by Brian Ward">
                    ...
                    <br> -Brian Ward, <a class="blockquote-links" target="_blank" rel="noopener noreferrer" href="https://nostarch.com/howlinuxworks3"><em>How Linux Works</em></a>
                </blockquote>
                ...
                <p class="article-content">
                    The topic of Linux distributions is a subject on its own, and your choice of Linux distribution is a personal one (very much like the choice to use Linux itself). I will simply point to certain distributions that are generally recommended for beginners and provide you with a brief tutorial on how to install Linux Mint (one of the more popular "beginner friendly" distros). Here is a brief list of distributions I recommend for beginners:
                </p>
                <ul class="article-lists">
                ...
                <figure>
                    <img
                        ...
                        title="A gif showing the basic usage of Balena Etcher"
                        cite="https://commons.wikimedia.org"
                        loading="lazy"
                    />
                    <figcaption>Basic Usage of Balena Etcher</figcaption>
                </figure>
                <p class="article-content">
                ...
                <figure>
                    <img
                        ...
                        title="An example picture of an ASUS BIOS Menu"
                        cite="https://commons.wikimedia.org"
                        loading="lazy"
                    />
                    <figcaption>An ASUS BIOS Menu, Your Menu May Look Different</figcaption>
                </figure>
                <p class="article-content">
                ...
                <figure>
                    <img
                        ...
                        title="A Picture of the GRUB Bootloader menu"
                        cite="screenshot"
                        loading="lazy"
                    />
                    <figcaption>The GRUB Bootloader</figcaption>
                </figure>
                <p class="article-content">
                ...
                <figure>
                    <img
                        ...
                        title="A Picture of Linux Mint's Live Desktop Environment"
                        cite="screenshot"
                        loading="lazy"
                    />
                    <figcaption>Linux Mint's Live Desktop Environment (Cinnamon Edition)</figcaption>
                </figure>
                <p class="article-content">
                ...
                <figure>
                    <img
                        ...
                        title="A Picture of Linux Mint Install Menu"
                        cite="screenshot"
                        loading="lazy"
                    />
                    <figcaption>A Picture of Linux Mint Install Menu</figcaption>
                </figure>
                <p class="article-content">
                ...
                <figure>
                    <img
                        ...
                        title="A Picture of The Linux Mint Login Screen"
                        cite="screenshot"
                        loading="lazy"
                    />
                    <figcaption>If All Went Well, You Should See A Login Screen</figcaption>
                </figure>
                <p class="article-content">
