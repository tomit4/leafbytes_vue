            ...
            <div class="article-body">
                <figure>
                    <img
                        ...
                        loading="lazy"
                    />
                <figcaption>An Ortholinear Keyboard</figcaption>
                </figure>
                ...
                <h4 class="article-header4">Introduction</h4>
                    <p class="article-content">If you've read any of my previous articles, you can probably tell that I'm pretty obsessed with The Keyboard-Centric Workflow. In utilizing the Vim Text Editor, The Vimium Browser Extension,  and a Tiling Window Manager, I can honestly say that my <em>potential</em> productivity has greatly increased. Although I owe a great deal of this increased potential productivity to the aforementioned pieces of software, there is one piece of hardware that has been a game-changer to my workflow and that is the ortholinear keyboard.
                    </p>
                    ...
                    <figure>
                        <img
                            ...
                            title="A Minimaliist Split OLKB"
                            cite="https://commons.wikimedia.org"
                            loading="lazy"
                        />
                        <figcaption>A Minimalist Split OLKB with multiple layer keys</figcaption>
                    </figure>
                    <figure>
                        <img
                            class="header-images"
                            ...
                            title="An Ergodox Split OLKB"
                            cite="https://commons.wikimedia.org"
                            loading="lazy"
                        />
                        <figcaption>An Ergodox Split OLKB</figcaption>
                    </figure>
                    <figure>
                        <img
                            class="header-images"
                            ...
                            title="An Miniaxe 40% Split OLKB"
                            cite="https://commons.wikimedia.org"
                            loading="lazy"
                        />
                        <figcaption>A Miniaxe 40% Split OLKB</figcaption>
                    </figure>
