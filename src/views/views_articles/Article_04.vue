    ...
    <div>
        <div class="article-entire">
            <div class="intro-header">
                <router-link class="next-btn" to="why-use-linux"></router-link>
            ...
            <div class="article-body">
                <figure>
                    <img
                        ...
                        loading="lazy"
                    />
                    <figcaption>The Vim Logo</figcaption>
                </figure>
...
Just like with choosing Linux, the choice of a text editor, like Vim, can become quickly political in nature due to the fact that VS Code is not entirely Open Source. While VS Code's source code is released under the permissive MIT license, the popular Microsoft release of this has proprietary software integrated into it. Additionally, VS Code utilizes telemetry by default, which goes against the FOSS world's advocacy for opt-in, and not opt-out, telemetry (The fork, VS-Codium, turns off this telemetry by default).
                ...
                <p class="article-content">
                    ...
                    the some information abut how to get started (:help vim &ltEnter$gt). I would encourage you to take a look at this help page, as Vim and Neovim documentation is quite good. I will now cover some of the basic keybindings and Vim "movements" in concluding this article, in order that you might get a sense of Vim's appeal.
                </p>
                <figure>
                    <img
                        class="header-images"
                        ...
                        title="The Introduction Screen to Neovim"
                        cite="screenshot"
                        loading="lazy"
                    />
                    <figcaption>The Introduction Screen to Neovim</figcaption>
                </figure>
                <p class="article-content">
                ...
                <figure>
                    <img
                        ...
                        title="Neovim in Insert Mode with Sample Text"
                        cite="screenshot"
                        loading="lazy"
                    />
                    <figcaption>Neovim in Insert Mode with Sample Text</figcaption>
                </figure>
                <br>
                <figure>
                    <img
                ...
                <figure>
                    <img
                        ...
                        title="Demonstration of basic navigation in Vim"
                        cite="screenshot"
                        loading="lazy"
                    />
                    <figcaption>Basic Navigation Demo in Vim using hjkl</figcaption>
                </figure>
                <p class="article-content">
                ...
                <figure>
                    <img
                        ...
                        title="Demonstration of word traversal in Vim"
                        cite="screenshot"
                        loading="lazy"
                    />
                    <figcaption>Basic Word Traversal in Vim</figcaption>
                </figure>
                <p class="article-content">
                ...
                <figure>
                    <img
                        ...
                        title="Demonstration of line traversal in Vim"
                        cite="screenshot"
                        loading="lazy"
                    />
                    <figcaption>Basic Line Traversal in Vim</figcaption>
                </figure>
                <p class="article-content">
                ...
                <figure>
                    <img
                        ...
                        title="Demonstration of vertical traversal in Vim"
                        cite="screenshot"
                        loading="lazy"
                    />
                    <figcaption>Basic Vertical Traversal in Vim</figcaption>
                </figure>
                <p class="article-content">
                ...
                <figure>
                    <img
                        ...
                        title="Demonstration of entire document traversal in Vim"
                        cite="screenshot"
                        loading="lazy"
                    />
                    <figcaption>You can traverse the entire document using 'gg' and 'G'</figcaption>
                </figure>
                <p class="article-content">
                ...
                <p class="article-content">
                    For this example, please stay in NORMAL mode (if you hit 'i' at any time prior to this and entered INSERT mode, simply return to NORMAL mode by hitting the &ltESC&gt key). Navigate to the beginning of any word in your document using 'w'. From here enter, the keys, 'dw', and witness the results, yes, very simply, we deleted a word.
                </p>
                <p class="article-content">
                ...
                <p class="article-content">
                    Also notice the chaining of commands here, 'd' is meant to be a mnemonic, reminding you of 'delete', but on its own doesn't do anything, it takes another command as an argument, so 'dw', means 'delete word.' We traverse using 'w' and when we come across a word we want to delete, we use the command 'd' and the argument, 'w', resultiing in 'dw'. What if we wanted to delete the previous word? Well we traverse using back to the previous word using the 'b' keybinding, so it makes sense that 'db', would be 'delete back' or 'delete previous word'.
                </p>
                <figure>
                    <img
                        class="header-images"
                        ...
                        title="Demonstration of deleting a word using 'dw' and 'db' in Vim"
                        cite="screenshot"
                        loading="lazy"
                    />
                    <figcaption>You can delete a word using the 'dw' and 'db' command chains</figcaption>
                </figure>
                <p class="article-content">
                ...
                <p class="article-content">
                    Suppose I think a bit on how else I can chain 'd' with other movement commands? What if I wish to delete just the next character to the right of me? Well 'l' will navigiate more cursor right, therefore d, 'delete' will 'delete' followed by 'l' 'one character to the right of me.' So 'dl' deletes one letter to the right of my cursor  and 'dh' will delete one character to the left of my cursor. What about 'dj'?
                </p>
                <p class="article-content">
                    Suppose I think a bit on how else I can chain 'd' with other movement commands? What if I wish to delete just the next character to the right of me? Well 'l' will navigiate more cursor right, therefore d, 'delete' will 'delete' followed by 'l' 'one character to the right of me.' So 'dl' deletes one letter to the right of my cursor  and 'dh' will delete one character too the left of my cursor. 'dj' will delete the entire next line, whereas 'dk' will delete the preceding line above.
                </p>
                <p class="article-content">
                ...
                <figure>
                    <img
                        ...
                        loading="lazy"
                    />
                    <figcaption>Various chaining of the 'd' command in Vim</figcaption>
                </figure>
                <p class="article-content">
                    And so on...
                </p>
