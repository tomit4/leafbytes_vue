        ...
        <div class="article-entire">
            ...
            <figure>
                <img
                    class="header-images"
                    id="i3_logo"
                    src="../../assets/i3_logo.webp"
                    alt="The i3 Logo"
                    title="The i3 Logo"
                    cite="https://commons.wikimedia.org"
                    loading="lazy"
                />
                <figcaption>The i3 Logo</figcaption>
            </figure>
...
Prior to the advent of computer screens, all visual output from the computer was generally reserved to reading out lengthy printed pages via a line printer, while computer screens were reserved for keeping track of the status of the programs themselves.
        ...
        <p class="article-content">
        I won't go into the extensive history of computer screens, window managers, tiling window managers, and desktop environments, but please see the <span class="footnotes-links" onclick="scrollToFootnotes()">footnotes</span> for the Wikipedia articles covering each of these subjects in more detail. Suffice it to say that the modern tiling window managers and desktop environments are the products of the long and arduous effort to bring computers into the modern home.
        </p>
        <p class="article-content">
...
There have been few articles written on the keyboard-centric workflow. The subject is the realm mainly focused on by productivity enthusiasts and computer programmers (perhaps also the occasional stenographer). I have touched briefly on the concepts of the keyboard-centric workflow in my article on The Vim Text Editor, but will spend more time elaborating on the subject here.
        ...
        <p class="article-content">
        I have always enjoyed the sensation of typing from an early age when I first sat down at a keyboard. In high school and especially college, I took the time to learn some of the classic keyboard shortcuts present in nearly every application. The knowledge of these shortcuts allowed me to navigate more quickly throughout applications, edit text more quickly, and generally work with the computer much faster than others. In short, I became what is known colloquially as a "power user". I won't go into the details of the standard shortcuts here (the likelihood is that you are already familiar with them if you're reading this article), but the <span class="footnotes-links" onclick="scrollToFootnotes()">Wikipedia article</span> on keybindings gives a good overview if you are unfamiliar with the term.
        </p>
        <p class="article-content">
...
Obviously, my preferences in Desktop Environment Design are geared towards creating a personalized keyboard-centric workflow that is unique to the regular user of that particular machine. The remainder of this article will focus on transitioning from a mouse-centric orientation with your computer towards a more keyboard-centric one, with the end goal of installing a Tiling Window Manager on Linux and the introducing the basics of utilizing it.
        ...
        <p class="article-content">
        As you may have already ascertained if you have read my <span class="inter-article-links" onclick="renderArticle('tech-subject-3')">Why Use Linux</span> article, Linux allows for a great deal of user freedom and choice. Linux Desktop Environments are no different. There are a wide variety of options for Desktop Environments, each with their own features, advantages, and disadvantages. I must confess I only have extensive experience in one of the Linux Desktop Environment, that being the XFCE desktop environment. If you are curious, the other popular Linux Desktop Environments currently include GNOME, KDE, Cinammon, and the LXQT Desktop environments. I cannot speak to the quality of these Desktop Environments, but would assume they have a similar, if not more, amount of customization options to the XFCE Desktop Environment.
        </p>
        <p class="article-content">
...
Firstly, let's start by configuring the keybindings in the XFCE Desktop Environment. Here we see the base install of Debian Linux with the default XFCE Desktop Environment installed:
        ...
        <figure>
            <img
                class="header-images"
                id="ss_debian_xfce"
                src="../../assets/ss_debian_xfce.webp"
                alt="The Default Debian XFCE Desktop Environment"
                title="The Default Debian XFCE Desktop Environment"
                cite="screenshot"
                loading="lazy"
            />
            <figcaption>The Default Debian XFCE Desktop Environment</figcaption>
        </figure>
        <p class="article-content">
The default terminal emulator in the XFCE Desktop Environment is called xfce4-terminal, thusly if we invoke it from the command line, another terminal emulator should spawn:
        ...
        <figure>
            <img
                class="header-images"
                id="ss_debian_xfce"
                src="../../assets/ss_debian_terminal_spawn.webp"
                alt="A Picture of the XFCE Terminal Calling Another Instance of Itself"
                title="A Picture of the XFCE Terminal Calling Another Instance of Itself"
                cite="screenshot"
                loading="lazy"
            />
            <figcaption>The XFCE Terminal Calling Another Instance of Itself</figcaption>
        </figure>
        <p class="article-content">And indeed it does. So now we know we can call xfce4-terminal by typing out that exact name into the command line, but what if I want to call it using a custom keybinding?
        </p>
        <p class="article-content">In XFCE's version of the start menu (located on the upper left hand side), you will find a menu item called "settings", where you will find the "keyboard" option. This is one of two GUI menus that allow for the modification of keybindings. Click on that so we can get started with one of the first recommended keybindings, that being of "super+enter", which we will bind to open our terminal emulator.
        </p>
        <figure>
            <img
                class="header-images"
                src="../../assets/ss_debian_xfce_keybindings01.webp"
...
I will now move onto our next subject, which covers the useful feature of Workspaces. The use of Workspaces is more important than Application-related keyboard shortcuts as they essentially maximize the use of space on your screen, allowing you to bring up an entirely new work area for you to fill with your various applications. Instead of moving application windows around and minimizing them when not in use, Workspaces allow you to simply keep those applications open at whatever screen size you like, hiding them from view temporarily, while you navigate to another workspace to do some other sort of work, and then navigate back to your previous workspace to utilize the applications you had been using earlier. The below gif demonstrates the use of Workspaces, which are changed using keybindings.
        ...
        <figure>
            <img
                class="header-images"
                id="ss_debian_02_gif"
                src="../../assets/ss_debian_keybinding_02.gif"
                alt="Demonstration of Navigating Workspaces in XFCE"
                title="Demonstration of Navigating Workspaces in XFCE"
                cite="screenshot"
                loading="lazy"
            />
...
Now we can simply reboot our machine, upon login, before entering your name and password, be sure to select i3 from the wrench icon available at the top right hand corner of our login screen:
        ...
        <figure>
            <img
                class="header-images"
                id="ss_debian_i3_01"
                src="../../assets/ss_debian_i3_01.webp"
                alt="Screenshot of i3 Selection in LightDm Menu"
                title="Screenshot of i3 Selection in LightDm Menu"
                cite="screenshot"
                loading="lazy"
            />
            <figcaption>Select i3 From Your Login Screen</figcaption>
        </figure>
        <p class="article-content">
Immediately you will be presented with a far more minimal set up than XFCE. You will be prompted if you'd like to generate a default configuration for i3, go ahead and choose "Yes" and hit enter.
        ...
        <figure>
            <img
                class="header-images"
                id="ss_debian_i3_02"
                src="../../assets/ss_debian_i3_02.webp"
                alt="Screenshot of i3 Welcome Prompt"
                title="Screenshot of i3 Welcome Prompt"
                cite="screenshot"
                loading="lazy"
            />
...
Afterwards which you will be asked which "Mod" key you'd like as default, either the "super" or "alt" key. This key will be the default for chaining with other keys which when used in sequence will call various applications and  change workspaces. I personally prefer the "super" key, so I'm going to choose the first option.
        ...
        <figure>
            <img
                class="header-images"
                id="ss_debian_i3_03"
                src="../../assets/ss_debian_i3_03.webp"
                alt="Screenshot of i3 mod key choice prompt"
                title="Screenshot of i3 mod key choice prompt"
                cite="screenshot"
                loading="lazy"
            />
...
After this choice is made and you hit enter, you'll be left with no further instruction, which can be jarring for beginners. Don't worry, remember the keybinding to call the terminal we made in XFCE? Well the reason I chose "super + enter," was because that is the same command in the default i3 configuration for calling the terminal. So you can do the same here in i3, calling the terminal with "super + enter". In fact, let's call a few terminals to see the default tiling behavior of i3, hit "super + enter" a couple of times:
        ...
        <figure>
            <img
                ...
                src="../../assets/ss_debian_i3_demo_01.gif"
                alt="Gif showing i3 calling terminals"
                title="Gif showing i3 calling terminals"
                cite="screenshot"
                loading="lazy"
            />
...
As you can see, a Tiling Window Manager "tiles" its windows in a cascading fashion, utilizing as much of the available screen space (known in some circles as screen "real estate"). So how do we navigate this? Well you can indeed use the mouse to select which of your open applications you'd like to utilize, but obvioiusly, this article being about the keyboard-centric workflow, we'll choose to navigate using our keyboard. Hiting "super+j" or "super+;"(super + semicolon) will navgate left and right respectively. Additionally, if we move a window to the bottom so that it is in a horizontal orientation using (super+shift+k), then we can demonstrate navigation up and down windows using (super+k) or (super+l)
        ...
        <figure>
            <img
                ...
                src="../../assets/ss_debian_i3_demo_02.gif"
                alt="Gif showing basic navigation in i3"
                title="Gif showing basic navigation in i3"
                cite="screenshot"
                loading="lazy"
            />
            <figcaption>Basic Navigation In i3 Tiling Window Manager</figcaption>
        </figure>
        <p class="article-content">
...
To log out of i3, enter super+shift+e. This will bring up a yellow message at the top of your screen asking if you'd like to exit i3, click 'Yes,' and it will return you to the login screen.
        ...
        <figure>
            <img
                ...
                src="../../assets/ss_debian_i3_demo_03.gif"
                alt="Demo of a highly customized i3 setup"
                title="Demo of a highly customized i3 setup"
                cite="screenshot"
                loading="lazy"
            />
        ...
        <ul class="footnotes">
            <li class="footnotes-item" id="footnote-1"><span class="return-caret" onclick="returnToOrig()">[^]</span> <a class="footnote-href" target="_blank" rel="noopener noreferrer" href="https://en.wikipedia.org/wiki/Computer_screen">Wiki: Computer Screen</a></li>
            <li class="footnotes-item" id="footnote-1"><span class="return-caret" onclick="returnToOrig()">[^]</span> <a class="footnote-href" target="_blank" rel="noopener noreferrer" href="https://en.wikipedia.org/wiki/Window_manager">Wiki: Window Manager</a></li>
            <li class="footnotes-item" id="footnote-1"><span class="return-caret" onclick="returnToOrig()">[^]</span> <a class="footnote-href" target="_blank" rel="noopener noreferrer" href="https://en.wikipedia.org/wiki/Tiling_window_manager">Wiki: Tiling Window Manager</a></li>
            <li class="footnotes-item" id="footnote-1"><span class="return-caret" onclick="returnToOrig()">[^]</span> <a class="footnote-href" target="_blank" rel="noopener noreferrer" href="https://en.wikipedia.org/wiki/Desktop_environment">Wiki: Desktop Environment</a></li>
            <li class="footnotes-item" id="footnote-1"><span class="return-caret" onclick="returnToOrig()">[^]</span> <a class="footnote-href" target="_blank" rel="noopener noreferrer" href="https://en.wikipedia.org/wiki/Keyboard_shortcuts">Wiki: Keyboard Shortcuts</a></li>
        </ul>
